...
export const SURVIVAL_GUIDES = [
  ...
  },
  {
    ...
    severity: 'info',
    summary: '平時善用政府軟體或地圖預先查詢居家、學校與公司周邊之防空避難處所及緊急醫療責任醫院。',
    steps: [
      '下載安裝「警政服務 App」或「消防防災 e 點通 App」查閱離線避難地圖。',
  ...
  },
  {
    ...
    title: '通訊中斷時警政與國防 FM 104.9 廣播收聽',
    severity: 'warning',
    summary: '當電力、手持網際網路與行動基地台中斷時，收音機為獲取政府權威指令與災情通報之最終管道。',
    steps: [
      '準備防災收音機：使用手搖發電或裝備備用電池之 FM/AM 便攜式收音機。',
      '調頻官方頻道：調至 FM 104.9 MHz（警察廣播電台 / 國家災害防救指定頻道）。',
      '定時收聽省電：為節省電池電量，可約定於每整點（如 09:00、12:00）開啟收聽 10 分鐘。',
      '筆記官方發布：紀錄政府公告之水糧發放點、避難疏散路線與醫療站資訊。'
    ],
    tips: [
      '平時宜預先將收音機天線拉長測試收訊，並儲放多組 AA/AAA 備用鹼性電池。'
    ]
  },
  {
    id: 'comms-1991-voicemail',
    categoryId: 'comms-info',
    title: '1991 報平安留言板與緊急求助專線',
    severity: 'info',
    summary: '大範圍災害致電信線路擁塞時，優先使用「1991 報平安語音留言板」記錄家屬安危，留出緊急救難通道。',
    steps: [
      '撥打 1991 專線：撥通後依語音指示輸入「約定電話號碼（如家長手機）」進行留言或聽取留言。',
      '網頁版報平安：利用 1991 網頁版 (www.1991.tw) 進行線上報平安登錄。',
      '緊急報案 110/119：僅在生命威脅、火災或嚴重創傷時撥打 110 或 119。',
      '市政與資務 1999：停水停電、民生物資查詢請撥打 1999 市民熱線。'
    ],
    tips: [
      '平時與家人約定好做為 1991 留言帳號的固定電話號碼（如住家電話或某一特定手機）。'
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'gb-radio', text: '5. 通訊工具：手搖/電池防災收音機（收聽 FM 104.9）、高分貝哨子。' },
      ...
      { id: 'gb-memo', text: '10. 記錄工具：防水筆與備忘筆記本（記錄緊急聯絡電話與 1991 約定）。' },
